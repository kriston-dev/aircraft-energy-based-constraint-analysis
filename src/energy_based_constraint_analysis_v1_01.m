...
Acceleration_horizontal = (Thrust_TO - Drag_avg_TO - Rolling_friction_coefficient .* (Weight_TO - Lift_avg_TO)) ./ Mass_TO; % Horizontal acceleration
