...
disp("25 - Turn stall-speed factor K_turn");

disp("26 - Horizontal acceleration velocity");
disp("27 - Required horizontal acceleration");
disp("28 - Horizontal acceleration altitude");

disp("29 - Approach velocity");
disp("30 - Approach stall-speed factor K_approach");
disp("31 - Approach altitude");
